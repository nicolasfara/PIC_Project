...
// get/set ADC_LM35 aliases
#define ADC_LM35_TRIS               TRISA0
#define ADC_LM35_LAT                LATA0
#define ADC_LM35_PORT               RA0
#define ADC_LM35_ANS                ANSA0
#define ADC_LM35_SetHigh()    do { LATA0 = 1; } while(0)
#define ADC_LM35_SetLow()   do { LATA0 = 0; } while(0)
#define ADC_LM35_Toggle()   do { LATA0 = ~LATA0; } while(0)
#define ADC_LM35_GetValue()         RA0
#define ADC_LM35_SetDigitalInput()    do { TRISA0 = 1; } while(0)
#define ADC_LM35_SetDigitalOutput()   do { TRISA0 = 0; } while(0)

#define ADC_LM35_SetAnalogMode()   do { ANSA0 = 1; } while(0)
#define ADC_LM35_SetDigitalMode()   do { ANSA0 = 0; } while(0)
