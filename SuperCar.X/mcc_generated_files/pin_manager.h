...
// get/set P1 aliases
#define P1_TRIS               TRISA2
#define P1_LAT                LATA2
#define P1_PORT               RA2
#define P1_ANS                ANSA2
#define P1_SetHigh()    do { LATA2 = 1; } while(0)
#define P1_SetLow()   do { LATA2 = 0; } while(0)
#define P1_Toggle()   do { LATA2 = ~LATA2; } while(0)
#define P1_GetValue()         RA2
#define P1_SetDigitalInput()    do { TRISA2 = 1; } while(0)
#define P1_SetDigitalOutput()   do { TRISA2 = 0; } while(0)

#define P1_SetAnalogMode()   do { ANSA2 = 1; } while(0)
#define P1_SetDigitalMode()   do { ANSA2 = 0; } while(0)
// get/set P2 aliases
#define P2_TRIS               TRISA3
#define P2_LAT                LATA3
#define P2_PORT               RA3
#define P2_ANS                ANSA3
#define P2_SetHigh()    do { LATA3 = 1; } while(0)
#define P2_SetLow()   do { LATA3 = 0; } while(0)
#define P2_Toggle()   do { LATA3 = ~LATA3; } while(0)
#define P2_GetValue()         RA3
#define P2_SetDigitalInput()    do { TRISA3 = 1; } while(0)
#define P2_SetDigitalOutput()   do { TRISA3 = 0; } while(0)

#define P2_SetAnalogMode()   do { ANSA3 = 1; } while(0)
#define P2_SetDigitalMode()   do { ANSA3 = 0; } while(0)
// get/set P3 aliases
#define P3_TRIS               TRISA4
#define P3_LAT                LATA4
#define P3_PORT               RA4
#define P3_ANS                ANSA4
#define P3_SetHigh()    do { LATA4 = 1; } while(0)
#define P3_SetLow()   do { LATA4 = 0; } while(0)
#define P3_Toggle()   do { LATA4 = ~LATA4; } while(0)
#define P3_GetValue()         RA4
#define P3_SetDigitalInput()    do { TRISA4 = 1; } while(0)
#define P3_SetDigitalOutput()   do { TRISA4 = 0; } while(0)

#define P3_SetAnalogMode()   do { ANSA4 = 1; } while(0)
#define P3_SetDigitalMode()   do { ANSA4 = 0; } while(0)
// get/set D0 aliases
