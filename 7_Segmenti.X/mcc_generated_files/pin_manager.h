...
// get/set K1 aliases
#define K1_TRIS               TRISA0
#define K1_LAT                LATA0
#define K1_PORT               RA0
#define K1_ANS                ANSA0
#define K1_SetHigh()    do { LATA0 = 1; } while(0)
#define K1_SetLow()   do { LATA0 = 0; } while(0)
#define K1_Toggle()   do { LATA0 = ~LATA0; } while(0)
#define K1_GetValue()         RA0
#define K1_SetDigitalInput()    do { TRISA0 = 1; } while(0)
#define K1_SetDigitalOutput()   do { TRISA0 = 0; } while(0)

#define K1_SetAnalogMode()   do { ANSA0 = 1; } while(0)
#define K1_SetDigitalMode()   do { ANSA0 = 0; } while(0)
// get/set K2 aliases
#define K2_TRIS               TRISA1
#define K2_LAT                LATA1
#define K2_PORT               RA1
#define K2_ANS                ANSA1
#define K2_SetHigh()    do { LATA1 = 1; } while(0)
#define K2_SetLow()   do { LATA1 = 0; } while(0)
#define K2_Toggle()   do { LATA1 = ~LATA1; } while(0)
#define K2_GetValue()         RA1
#define K2_SetDigitalInput()    do { TRISA1 = 1; } while(0)
#define K2_SetDigitalOutput()   do { TRISA1 = 0; } while(0)

#define K2_SetAnalogMode()   do { ANSA1 = 1; } while(0)
#define K2_SetDigitalMode()   do { ANSA1 = 0; } while(0)
